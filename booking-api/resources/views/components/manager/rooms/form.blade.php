...
<form action="{{ route('manager.hotels.rooms.store', $hotel->id) }}" method="POST" enctype="multipart/form-data">
@csrf
    ...
    <div class="mt-4">
        ...
        <input id="floor_area" class="block mt-1 w-full" type="number" name="floor_area" value="{{ old('floor_area') }}" required>
    </div>
    <div class="mt-4">
        <label for="type">Тип</label>
        <input id="type" class="block mt-1 w-full" type="text" name="type" value="{{ old('type') }}" required>
    </div>
    <div class="mt-4">
        <label for="price">Цена</label>
        <input id="price" class="block mt-1 w-full" type="number" name="price" value="{{ old('price') }}" required>
    </div>
    <div class="mt-4">
